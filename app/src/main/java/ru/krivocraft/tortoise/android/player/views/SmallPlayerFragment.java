...
public class SmallPlayerFragment extends BaseFragment implements PlayerFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        this.rootView = view;
        rootView.findViewById(R.id.fragment_button_next).setOnClickListener(view1 -> controller.next());
        rootView.findViewById(R.id.fragment_button_previous).setOnClickListener(view1 -> controller.previous());
    ...
    public void showPlaybackStateChanges() {
        if (rootView != null && playbackState != null) {
            ...
            if (playbackState.getState() == PlaybackStateCompat.STATE_PLAYING) {
                ...
                playPauseCompositionButton.setOnClickListener(v -> controller.pause());
                cancelCurrentTimer();
                startNewTimer(bar);
            } else {
                playPauseCompositionButton.setImageResource(R.drawable.ic_play);
                playPauseCompositionButton.setOnClickListener(v -> controller.play());
                cancelCurrentTimer();
            }
        }
        ...
        if (rootView != null && metadata != null) {
            ...
            if (context != null) {
                ...
                if (trackArt != null) {
                    ...
                    int color = colors.getColor(tracksStorageManager.getTrack(tracksStorageManager.getReference(metadata.getString(MediaMetadataCompat.METADATA_KEY_MEDIA_URI))).getColor());
                    changeColors(color);
                }
